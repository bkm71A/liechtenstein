...
public class EUnitConverter {
     ...
     * @return array of EUnit objects representing all supported engineering units for a specific domain
     */
     ...
     * @param domain physical domain (acceleration, velocity, time etc.)
    ...
    /**
     * Lookup PhysicalDomain enum member by description: Acceleration, Velocity, Displacement, Frequency, Time,
     * Temperature
    ...
    public static double convert( double value, EUnit sourceUnit, EUnit targetUnit ) {
        ...
        // if unit not default: first, convert to default then convert to new target
     ...
     * @param targetUnit target engineering unit (source is assumed to be default system unit)
     */
     ...
     * Perform in-place conversion of the list of elements
     * @param values values to convert
     * @param sourceUnit source engineering unit
     * @param targetUnit target engineering unit
     */
     ...
     * Perform in-place conversion of the list of elements
     * @param values values to convert
     * @param targetSymbol target engineering unit symbol (source is assumed to be default system unit)
     */
     ...
     * Perform in-place conversion of the list of elements
     * @param values values to convert
     * @param sourceSymbol source engineering unit symbol
     * @param targetSymbol target engineering unit symbol
     */
