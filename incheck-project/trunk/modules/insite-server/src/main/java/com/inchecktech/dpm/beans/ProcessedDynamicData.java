...
/**
 * This object represents a processed/calculated data set of data bins (points) that will be used to plot different
 * types of graphs. It also contains meta-data such as measurements units, applied calculation type etc.
 * @author Taras Dobrovolsky Change History: 11/03/2007 Taras Dobrovolsky Changed get/set methods for dataTicks to be
 *         public 03/19/2008 Taras Dobrovolsky Added min/max 07/11/2008 Taras Dobrovolsky Added methods for engineering
 *         units handling
 */
public class ProcessedDynamicData implements ProcessedData, Serializable {

    static final long serialVersionUID = 8041341458741097771L;
    ...
    private String              measurementType   = ProcessedData.MEASUREMENT_TYPE_DELTA;
    ...
    public String toString( ) {
        ...
        StringBuilder str = new StringBuilder( "ProcessedDynamicData:" );
