package com.incheck
{
	...
	{		
		...
		public function resultHandler(event:ResultEvent):void
		{
			...
			var processData:Object = ObjectProxy(event.result).object_proxy::object as Object;
			if (processData == null)
			{
				//Alert.show("No processData for id: "+id+" type: " + _chartType)
				return;
			}
			if (processData.chartData == null)
			{
				//Alert.show("No processedData.chartData for id: "+id+" type: " + _chartType)
				return;
			}
			// convert to the user's preferred units
			var newArr:Array = processData.chartData.source as Array;
			...
			if (chDisplayObj != null && chDisplayObj.rms != null)
			{
