       ...
       // private var _dragTool:String;
    	...
    	public function RangeSelector():void
    	{
            ...
            Application.application.addEventListener(MouseEvent.MOUSE_UP, mouseUp);
          	//Application.application.addEventListener(MouseEvent.MOUSE_MOVE,debugMove);
            Application.application.addEventListener(KeyboardEvent.KEY_DOWN, keyPressed);
			Application.application.addEventListener(KeyboardEvent.KEY_DOWN, keyDePressed);
...
//            Alert.show(pare);
            ...
            Application.application.addEventListener("mouseUp",endTracking,true);

            Application.application.addEventListener("mouseMove",track,true);
        ...
        private function endTracking(e:MouseEvent):void
        {
		   ...
		   bTracking = false;
            Application.application.removeEventListener("mouseUp",endTracking,true);
            Application.application.removeEventListener("mouseMove",track,true);
