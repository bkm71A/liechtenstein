...
package com.incheck
{
	...
	public class ChartBox extends VBox
	{
		...
		public  function ChartBox(){
			super();
//			this.addEventListener(MouseEvent.MOUSE_OVER,containerMouseOver, false, 0, true);
	//		this.addEventListener(MouseEvent.MOUSE_OUT,containerMouseOut, false, 0, true);
		//	this.addEventListener(Event.ENTER_FRAME,addVcurs, false, 0, true);
