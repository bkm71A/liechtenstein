...
import com.incheck.ng.service.UserSaveException;
import com.incheck.ng.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.incheck.ng.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * {@inheritDoc}
     */
    public User saveUser(User user) throws UserSaveException {
