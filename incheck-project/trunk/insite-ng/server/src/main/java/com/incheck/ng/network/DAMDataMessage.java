...
public class DAMDataMessage {
    ...
    private List<int[]> arrayOfIntArrays;

    public List<int[]> getArrayOfIntArrays() {
        return arrayOfIntArrays;
    }

    public void setArrayOfIntArrays(List<int[]> arrayOfIntArrays) {
    ...
    public DAMDataMessage(String header) {
        ...
        damChannelId = Long.parseLong(headerLines[4].trim().split(":")[1]);
