...
public class UserManagerImplTest extends BaseManagerMockTestCase {
    ...
    public void testAddAndRemoveUser() throws Exception {
        ...
        Role role = roleManager.getRole(RoleTypes.ROLE_USER.toString());
        user.addRole(role);
    ...
    @Test
    public void testUserSaveException() {
        // set expectations
        final User user = new User("admin");
        user.setEmail("admin@inchecktech.com");
        ...
        try {
            ...
            fail("Expected UserSaveException not thrown");
