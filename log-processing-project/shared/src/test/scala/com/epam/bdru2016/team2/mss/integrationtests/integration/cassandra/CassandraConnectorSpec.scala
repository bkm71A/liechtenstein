...
class CassandraConnectorSpec extends FeatureSpec with Matchers with SparkSpec with GivenWhenThen with Logging {
  ...
  feature("Playing with CassandraConnector") {
    scenario("Basic read write", CassandraTest) {
    ...
    scenario("Write case class", CassandraTest) {
    ...
    scenario("Write case class with complex names", CassandraTest) {
    ...
    scenario("Write case class with nested UDT", CassandraTest) {
