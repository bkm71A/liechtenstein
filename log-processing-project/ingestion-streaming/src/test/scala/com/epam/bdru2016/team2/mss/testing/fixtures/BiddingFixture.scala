package com.epam.bdru2016.team2.mss.testing.fixtures

import com.epam.bdru2016.team2.mss.model._
...
object BiddingFixture {
  ...
  def createEvent(ipinyouId:String = "VhkR1aq4DoCIQOE", ts:Long = 1370721600000L + 60*60*1000) = new BiddingEvent(
    "123",
